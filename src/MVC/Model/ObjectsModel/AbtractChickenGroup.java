...
public abstract class AbtractChickenGroup extends GameObject implements Clockable , Serializable {
    private int clock;
...
//    private int y;
    ...
    public AbtractChickenGroup(int number, int groupType, int wave, int chickenType, int m) {
